...
const { getSignatureDigest, getDaiDigest, getPermitDigest, privateKey0, signPacked } = signatures
      ...
      describe('borrowing', () => {
        ...
        describe('repaying', () => {
          beforeEach(async () => {
            ...
            daiSig = signPacked(digest, privateKey0)
            ...
            controllerSig = signPacked(digest, privateKey0)
          })
